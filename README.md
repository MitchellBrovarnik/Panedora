...
*   **Pandora Plus or Pandora Premium subscription** — a free Pandora account will **not** work. This application requires a paid subscription for full API access, uninterrupted playback, and high-quality audio streaming.
...
> [!TIP]
> **DISCLAIMER:** This application only works on active Pandora Plus or Premium subscription. Using a paid account ensures full compatibility with all playback features, provides the highest audio quality, and directly supports the artists on the platform.